...
from cancernet.pnet.data.pathways.reactome import Reactome, ReactomeNetwork
...
print(
    "# of root nodes {} , # of terminal nodes {}".format(
        len(reactome_net.get_roots()), len(reactome_net.get_terminals())
    )
)
