...
selected_genes = (
    "tcga_prostate_expressed_genes_and_cancer_genes_and_memebr_of_reactome.csv"
)
data_base = {
    "id": "ALL",
    "type": "prostate_paper",
...
nn_pathway_fixed_lr = deepcopy(nn_pathway)
nn_pathway_fixed_lr["id"] = "P-net_fixed_lr"
nn_pathway_fixed_lr["params"]["fitting_params"]["save_name"] = "pnet_fixed_lr"
